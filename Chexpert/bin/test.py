...
parser.add_argument('--in_csv_path', default='test_ground_truth.csv', metavar='IN_CSV_PATH',
...
def run(args):
    with open(args.model_path + 'parameters.json') as f:
    ...
    ckpt_path = os.path.join(args.model_path, 'best_result.ckpt')
